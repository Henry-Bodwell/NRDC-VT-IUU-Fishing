...
if not cites_api_key:
    raise ValueError("CITES_API_KEY not found in environment variables. Please set it in your .env file.")

iucn_api_key = os.getenv("IUCN_API_KEY")
if not iucn_api_key:
    raise ValueError("IUCN_API_KEY not found in environment variables. Please set it in your .env file.")
